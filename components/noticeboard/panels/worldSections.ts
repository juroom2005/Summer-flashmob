...
export const WORLD_SECTIONS: WorldSection[] = [
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "방학 직전부터 의사를 묻겠노라며 구두로 떠들고 다니던 그 선택의 시간이 기어이 오고 만 것이다. 모브 본인도 발로 뛰고, 친구의 친구를 수소문하고, 또 여럿을 설득하러 돌아다니고 있던 그 웃기지도 않는 버킷리스트의 때가! 그 많은 내용 중 첫 번이 하필 플래시 몹일 건 또 뭐람? 도대체 그놈의 춤이 뭐라고 이렇게까지 하는지 모르겠으나 연습실도, 참가비도, 게다가 아르바이트 자리마저 챙겨준다고 하니 각기 다른 이유들로 이 웃기지도 않는 도련님의 계획에 동참하게 됐다. 그도 그럴… 춤만 조금 연습하면 손해 볼 게 없으니까!",
      },
      {
        type: "p",
